...
\begin{figure}
	\includegraphics[width=\linewidth]{Figs/scatter_SE.png}
...
\begin{table}[!htbp] \centering 
	\begin{adjustbox}{width=1\textwidth}
		\begin{tabular}{@{\extracolsep{5pt}}lD{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} } 
			...
			\multicolumn{8}{c}{All models include controls for sex, education, income, race, following public affairs, and trust in government.}   
		\end{tabular} 
	\end{adjustbox}
